...
parser.add_argument('--add_skies', default=False, action='store_true',
                    help='add skies to 3d enviroment')

parser.add_argument('--add_ground', default=0, type=int,
                    help='add ground to 3d enviroment')
...
def init_work(args):
    ...
    if args.add_ground > 0:
        skretch = add_ground(skretch, args.add_ground, x=0, y= 0,color = (75,75,75))
